<template>
  ...
  >
    <div
      class="bg-white rounded-2xl p-6 w-full max-w-xs text-center shadow-xl animate-scaleIn"
    >
      <!-- Icon -->
      ...
      <div class="flex gap-3">
        ...
        <button
          class="flex-1 py-2 rounded-lg text-sm font-semibold bg-[#1e88e5] text-white active:scale-95 transition-all"
          @click="$emit('yes')"
        >
          {{ yesText }}
        </button>
